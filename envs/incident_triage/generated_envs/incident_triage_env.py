"""Incident triage environment for Space training."""
...
class IncidentTriageEnv:
    """Environment for diagnosing incidents from partial observations."""
    ...
    def _reward(self, payload: dict[str, Any], malformed: bool) -> tuple[float, dict[str, float]]:
        ...
        has_reasoning = isinstance(payload.get("reasoning"), str) and bool(payload.get("reasoning", "").strip())
